/* File generated from [main.pc] by OMPi compiler with torc extensions user/chriskar/hompi_start-v2.0.0-463-gde15e85~, Tue Jun 11 17:57:31 2019
$OMPi__nfo:0
*/
...
extern void __bzero(void * __s, long unsigned int __n);
...
/* (l41) typedef union _noname4_  __huge_val_t; */

static union _noname4_ __huge_val = { {
...
/* (l39) typedef union _noname5_  __huge_valf_t; */

static union _noname5_ __huge_valf = { {
    0, 0, 0x80, 0x7f
  } };
union _noname6_ {
...
static union _noname6_ __huge_vall = { {
...
static union _noname7_ __qnan_union = { {
    0, 0, 0xc0, 0x7f
  } };
...
/* (l354) typedef enum _noname8_  _LIB_VERSION_TYPE; */

extern enum _noname8_ _LIB_VERSION;
struct exception {
    int type;
    char * name;
    double arg1;
...
/* (l55) typedef enum _noname9_  idtype_t; */
...
/* (l62) typedef struct _noname10_  div_t; */
...
/* (l70) typedef struct _noname11_  ldiv_t; */
...
/* (l82) typedef struct _noname12_  lldiv_t; */
...
/* (l30) typedef struct _noname13_  __sigset_t; */
...
/* (l77) typedef struct _noname14_  fd_set; */

/* (l84) typedef __fd_mask fd_mask; */

extern int select(int __nfds, struct _noname14_ (* __readfds), struct _noname14_ (* __writefds), struct _noname14_ (* __exceptfds), struct timeval * __timeout);
extern int pselect(int __nfds, struct _noname14_ (* __readfds), struct _noname14_ (* __writefds), struct _noname14_ (* __exceptfds), const struct timespec * __timeout, const struct _noname13_ (* __sigmask));
...
/* (l128) typedef union _noname15_  pthread_mutex_t; */
...
/* (l134) typedef union _noname16_  pthread_mutexattr_t; */
...
/* (l154) typedef union _noname17_  pthread_cond_t; */
...
/* (l160) typedef union _noname18_  pthread_condattr_t; */
...
/* (l222) typedef union _noname19_  pthread_rwlock_t; */
...
/* (l228) typedef union _noname20_  pthread_rwlockattr_t; */
...
/* (l243) typedef union _noname21_  pthread_barrier_t; */
...
/* (l249) typedef union _noname22_  pthread_barrierattr_t; */
...
extern struct _noname10_ div(int __numer, int __denom);
extern struct _noname11_ ldiv(long int __numer, long int __denom);
extern struct _noname12_ lldiv(long long int __numer, long long int __denom);
...
extern int pthread_mutex_init(union _noname15_ (* __mutex), const union _noname16_ (* __mutexattr));
extern int pthread_mutex_destroy(union _noname15_ (* __mutex));
extern int pthread_mutex_trylock(union _noname15_ (* __mutex));
extern int pthread_mutex_lock(union _noname15_ (* __mutex));
extern int pthread_mutex_timedlock(union _noname15_ (* __mutex), const struct timespec * __abstime);
extern int pthread_mutex_unlock(union _noname15_ (* __mutex));
extern int pthread_mutex_getprioceiling(const union _noname15_ (* __mutex), int * __prioceiling);
extern int pthread_mutex_setprioceiling(union _noname15_ (* __mutex), int __prioceiling, int * __old_ceiling);
extern int pthread_mutex_consistent(union _noname15_ (* __mutex));
extern int pthread_mutexattr_init(union _noname16_ (* __attr));
extern int pthread_mutexattr_destroy(union _noname16_ (* __attr));
extern int pthread_mutexattr_getpshared(const union _noname16_ (* __attr), int * __pshared);
extern int pthread_mutexattr_setpshared(union _noname16_ (* __attr), int __pshared);
extern int pthread_mutexattr_gettype(const union _noname16_ (* __attr), int * __kind);
extern int pthread_mutexattr_settype(union _noname16_ (* __attr), int __kind);
extern int pthread_mutexattr_getprotocol(const union _noname16_ (* __attr), int * __protocol);
extern int pthread_mutexattr_setprotocol(union _noname16_ (* __attr), int __protocol);
extern int pthread_mutexattr_getprioceiling(const union _noname16_ (* __attr), int * __prioceiling);
extern int pthread_mutexattr_setprioceiling(union _noname16_ (* __attr), int __prioceiling);
extern int pthread_mutexattr_getrobust(const union _noname16_ (* __attr), int * __robustness);
extern int pthread_mutexattr_setrobust(union _noname16_ (* __attr), int __robustness);
extern int pthread_rwlock_init(union _noname19_ (* __rwlock), const union _noname20_ (* __attr));
extern int pthread_rwlock_destroy(union _noname19_ (* __rwlock));
extern int pthread_rwlock_rdlock(union _noname19_ (* __rwlock));
extern int pthread_rwlock_tryrdlock(union _noname19_ (* __rwlock));
extern int pthread_rwlock_timedrdlock(union _noname19_ (* __rwlock), const struct timespec * __abstime);
extern int pthread_rwlock_wrlock(union _noname19_ (* __rwlock));
extern int pthread_rwlock_trywrlock(union _noname19_ (* __rwlock));
extern int pthread_rwlock_timedwrlock(union _noname19_ (* __rwlock), const struct timespec * __abstime);
extern int pthread_rwlock_unlock(union _noname19_ (* __rwlock));
extern int pthread_rwlockattr_init(union _noname20_ (* __attr));
extern int pthread_rwlockattr_destroy(union _noname20_ (* __attr));
extern int pthread_rwlockattr_getpshared(const union _noname20_ (* __attr), int * __pshared);
extern int pthread_rwlockattr_setpshared(union _noname20_ (* __attr), int __pshared);
extern int pthread_rwlockattr_getkind_np(const union _noname20_ (* __attr), int * __pref);
extern int pthread_rwlockattr_setkind_np(union _noname20_ (* __attr), int __pref);
extern int pthread_cond_init(union _noname17_ (* __cond), const union _noname18_ (* __cond_attr));
extern int pthread_cond_destroy(union _noname17_ (* __cond));
extern int pthread_cond_signal(union _noname17_ (* __cond));
extern int pthread_cond_broadcast(union _noname17_ (* __cond));
extern int pthread_cond_wait(union _noname17_ (* __cond), union _noname15_ (* __mutex));
extern int pthread_cond_timedwait(union _noname17_ (* __cond), union _noname15_ (* __mutex), const struct timespec * __abstime);
extern int pthread_condattr_init(union _noname18_ (* __attr));
extern int pthread_condattr_destroy(union _noname18_ (* __attr));
extern int pthread_condattr_getpshared(const union _noname18_ (* __attr), int * __pshared);
extern int pthread_condattr_setpshared(union _noname18_ (* __attr), int __pshared);
extern int pthread_condattr_getclock(const union _noname18_ (* __attr), int (* __clock_id));
extern int pthread_condattr_setclock(union _noname18_ (* __attr), int __clock_id);
...
extern int pthread_barrier_init(union _noname21_ (* __barrier), const union _noname22_ (* __attr), unsigned int __count);
extern int pthread_barrier_destroy(union _noname21_ (* __barrier));
extern int pthread_barrier_wait(union _noname21_ (* __barrier));
extern int pthread_barrierattr_init(union _noname22_ (* __attr));
extern int pthread_barrierattr_destroy(union _noname22_ (* __attr));
extern int pthread_barrierattr_getpshared(const union _noname22_ (* __attr), int * __pshared);
extern int pthread_barrierattr_setpshared(union _noname22_ (* __attr), int __pshared);
...
void torc_remote_imagetask_torctask(char * par_name, int (* _ompix_seqno));
...
void torc_remote_imagetask(char * par_name, int seqno)
{
  ...
  struct lpiImage * src;
  char name[ 512];
  int X[ 64], Y[ 64], H[ 64], W[ 64];
  float O[ 64];
  int nofFaces;

  printf("\n\nNode #%d\n", torc_node_id());
  name[0] = '\0';
  __isoc99_sscanf(par_name, "%s", name);
  ...
  for (i = 0; i < num_nodes; i++)
    {
      ...
      torc_create_ox(0, i, -1, 0, -1, torc_instat_torctask, (void *) 0, 0);
    }
  ...
  while (fgets(buf, sizeof((buf)), fp) != ((void *) 0))
    {
      ...
      /* #pragma ompix task  */
      {
        ...
        int _ompix_1 = j;
                ...
                torc_create_ox(0, -1, -1, 0, -1, torc_remote_imagetask_torctask, (void *) 0, 2, 512, 8, 2, 1, 0, 1, name_cpies[j], &_ompix_1);
      }
      j++;
    }
  t2 = my_gettime();
...
int main(int argc, char **argv)
{
  ...
  ort_initialize(&argc, &argv, 0, 1, "proc2");
